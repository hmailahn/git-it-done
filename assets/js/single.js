...
if (issues.length === 0) {
    ...
    for (var i = 0; i < issues.length; i++) {
        //create a link ellemnt to take users to the issue on github
        var issueEl = document.createElement("a");
        issueEl.classList = "list-item flex-row jusitfy-space-between align-center";
